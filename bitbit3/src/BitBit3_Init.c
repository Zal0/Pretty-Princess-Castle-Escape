...
void InitSprites() {
	...
	INIT_SPRITE_COLOR(SPRITE_ZURRAPA,  zurrapa,   0, FRAME_16x16,  2);
	INIT_SPRITE_COLOR(SPRITE_PARTICLE, particles, 2, FRAME_16x16,  6);
	INIT_SPRITE_COLOR(SPRITE_AXE,      princess,  2, FRAME_16x16, 10);
	INIT_SPRITE_COLOR(SPRITE_AZNAR,    aznar,     2, FRAME_16x16,  5);
	INIT_SPRITE_COLOR(SPRITE_FLAG,     flag,      0, FRAME_16x16,  2);
}
